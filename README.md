...
3.  Run `03_second_stage_NMDS.R` to reproduce the first and second-stage Non-metric MultiDimensional Scaling analysis and figures (Figures 2, 3, S3, S4, S5, and S6; Table S1, S3, S4, and S5)
4.  Run `04_zoop_RDA.R` to reprodice redundnacy analyses and figure (Figure 4; Tables 1, 2, S2, S6, S7, and S8)
5.  Run `05_indicator_species_analysis.R` to reproduce the indicator species analysis and figure (Figure 5; Table S9)
